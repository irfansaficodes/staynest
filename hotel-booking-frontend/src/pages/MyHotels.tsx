...
const MyHotels = () => {
  ...
  const deleteMutation = useMutation(apiClient.deleteMyHotel, {
    onSuccess: () => {
      showToast({ title: "Hotel Deleted", description: "Hotel has been removed successfully", type: "SUCCESS" });
    },
    onError: () => {
        ...
        <Card className="max-w-lg w-full">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              To view and manage your hotels, please sign in to your account.
            </p>
            <Link to="/sign-in">
  ...
  if (!hotelData) {
    return (
      <EmptyState
        ...
        description="You haven't added any hotels yet. Get started by listing your first property."
        actionLabel="Add Your First Hotel"
        actionLink="/add-hotel"
      />
    );
  }
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 flex-grow">
                ...
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  <Hotel className="w-4 h-4 text-primary-600 flex-shrink-0" />
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="bg-red-500 text-white py-3 px-4 rounded-xl font-semibold hover:bg-red-600 transition-colors flex items-center justify-center disabled:opacity-50"
