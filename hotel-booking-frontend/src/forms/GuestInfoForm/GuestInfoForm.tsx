              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    aria-required="true"
                    aria-invalid={errors.adultCount ? "true" : "false"}
                    aria-describedby={errors.adultCount ? "adult-error" : undefined}
                    {...register("adultCount", {
                  ...
                  />
                  {errors.adultCount && (
                    <span id="adult-error" role="alert" className="text-red-500 text-xs">
