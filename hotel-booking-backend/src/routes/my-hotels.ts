...
router.get("/", verifyToken, requireHotelOwner, async (req: Request, res: Response) => {
  try {
...
router.get("/:id", verifyToken, requireHotelOwner, async (req: Request, res: Response) => {
...
router.delete("/:hotelId", verifyToken, requireHotelOwner, async (req: Request, res: Response) => {
  try {
    const hotel = await Hotel.findOne({
      _id: req.params.hotelId,
      userId: req.userId,
